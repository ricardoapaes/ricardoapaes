...
- [ricardoapaes/docker-java-jlink](https://github.com/ricardoapaes/docker-java-jlink) ([v1.0.3](https://github.com/ricardoapaes/docker-java-jlink/releases/tag/v1.0.3), 4 days ago) - Imagem do Docker para gerar um jre usando jlink
