...
- [pedroslopez/whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js) ([v1.25.0](https://github.com/pedroslopez/whatsapp-web.js/releases/tag/v1.25.0), 5 days ago) - A WhatsApp client library for NodeJS that connects through the WhatsApp Web browser app
