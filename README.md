...
- [pedroslopez/whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js) ([v1.24.0](https://github.com/pedroslopez/whatsapp-web.js/releases/tag/v1.24.0), 1 week ago) - A WhatsApp client library for NodeJS that connects through the WhatsApp Web browser app
...
- [tauri-apps/tauri](https://github.com/tauri-apps/tauri) - Build smaller, faster, and more secure desktop applications with a web frontend. (5 months ago)
