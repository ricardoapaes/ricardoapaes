...
- [openboxes/openboxes](https://github.com/openboxes/openboxes) ([v0.9.5-hotfix3](https://github.com/openboxes/openboxes/releases/tag/v0.9.5-hotfix3), 4 weeks ago) - OpenBoxes is a supply chain management system designed to manage inventory and track stock movements for healthcare facilities.
