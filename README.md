...
- [ricardoapaes/exe-sign](https://github.com/ricardoapaes/exe-sign) ([v1.1.0](https://github.com/ricardoapaes/exe-sign/releases/tag/v1.1.0), today) - Docker image to sign an executable using osslsigncode.
