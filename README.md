...
- [ricardoapaes/check-encoding-ci](https://github.com/ricardoapaes/check-encoding-ci) - Checks and encodes files in the repository. (4 days ago)
...
- [ricardoapaes/check-encoding-ci](https://github.com/ricardoapaes/check-encoding-ci) ([v0.0.1](https://github.com/ricardoapaes/check-encoding-ci/releases/tag/v0.0.1), 4 days ago) - Checks and encodes files in the repository.
